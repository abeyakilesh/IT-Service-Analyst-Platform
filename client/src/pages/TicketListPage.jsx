                                ...
                                {tickets.map((ticket) => (
                                    <tr key={ticket._id} className="hover:bg-slate-800/30 transition-colors">
                                        <td className="px-5 py-3">
                                            <Link to={`/tickets/${ticket._id}`} className="text-sm text-blue-400 hover:text-blue-300 font-medium">
                                                {ticket.title}
                                            </Link>
                                        </td>
                                        <td className="px-5 py-3 text-sm text-slate-400">{ticket.categoryId?.name || '—'}</td>
                                        <td className="px-5 py-3">
                                        ...
                                        <td className="px-5 py-3 text-sm text-slate-400">{ticket.createdBy?.name || '—'}</td>
                        ...
                        <div className="flex items-center justify-between px-5 py-3 border-t border-slate-800">
                            ...
                            <div className="flex gap-2">
                                <button
                                    ...
                                    className="px-3 py-1 text-xs bg-slate-800 text-slate-300 rounded-lg disabled:opacity-50"
                                >
                                    Previous
                                </button>
                                <button
